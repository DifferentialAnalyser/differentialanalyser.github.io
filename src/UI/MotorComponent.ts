  ...
  render() {
    return svg`
      <svg
        ...
        viewBox="0 0 100 50"
      >
        <rect x="11" y="1" width="70" height="48" fill="white" stroke="black" stroke-width="2" rx="5" />
        <rect x="81" y="10" width="10" height="30" fill="white" stroke="black" stroke-width="2" rx="2" />
